CREATE OR REPLACE FUNCTION spdv.del_produto_subcategorias(request_raw json) RETURNS json AS $$
import json
...
sql = """
  UPDATE spdv.produto_subcategorias u set ativo = false WHERE u.id = $1
"""
